...
/**
* get week day strings ordered according to the user's locale (week starts with Sunday or Monday)
* if shortNames is YES, abbreviated weekday names are returned, else the full names are returned
*
* @param shortNames
*
* @return list of strings representing week day names, starting with the name of the first week day
*/
