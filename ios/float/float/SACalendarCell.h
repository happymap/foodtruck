...
/**
 *  a filled circle that appears on the highlighted date
 */
@property UIImageView *highlightedView;

/**
 *  a blank circle that appears on the current date
 */
@property UIView *circleView;

/**
 *  a blank circle that appears on the selected date
 */
