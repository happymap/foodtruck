...
var nearbyTrucksQuery = function(lat, lng, distance, day, time) {
	return "SELECT truck.truck_id, truck.cuisine, schedule.schedule_id, schedule.address, truck.name, truck.description, truck.logo, schedule.start_time, schedule.end_time, "
